...
public class ModStructures {
    ...
    public static final DeferredRegister<StructureFeature<?>> DEFERRED_REGISTRY_STRUCTURE =
            DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, MinersDream.MOD_ID);

    /**
     * Registers the base structure itself and sets what its path is. In this case,
     * this base structure will have the resourcelocation of structure_tutorial:sky_structures.
     */
    public static final RegistryObject<StructureFeature<?>> PLACE_ORE_NODES =
            DEFERRED_REGISTRY_STRUCTURE.register("sky_structures", PlaceOreNodes::new);
