...
public class MinerRecipe implements Recipe<SimpleContainer> {
    private final ResourceLocation id;
    private final ItemStack output;
    private final NonNullList<Ingredient> recipeItems;

    public MinerRecipe(ResourceLocation id, ItemStack output,
    ...
    public static class Serializer implements RecipeSerializer<MinerRecipe> {
        ...
        public static final ResourceLocation ID =
                new ResourceLocation(MinersDream.MOD_ID,"miner");
        ...
        public MinerRecipe fromJson(ResourceLocation id, JsonObject json) {
            ...
            return new MinerRecipe(id, output, inputs);
        }
